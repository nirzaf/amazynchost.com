        ...
        <div className="footer-content">
          <div className="footer-grid">
            <div className="footer-column">
              <h3>AmazyncHost</h3>
              <p>Providing reliable hosting solutions since 2010. Our mission is to help businesses of all sizes establish their online presence with ease and confidence.</p>
          ...
          <div className="footer-bottom">
            <div className="copyright">
              <p>&copy; {new Date().getFullYear()} AmazyncHost. All rights reserved.</p>
            </div>
